...
@sammy.on_message(pyrogram.filters.command(["help"]))
    ...
    if update_channel:
        try:
            ...
            await update.reply_text(
                text="**🥺 Please First Join My Update Channel Before Using Me..**",
...
@sammy.on_message(pyrogram.filters.command(["start"]))
    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/SiderzBot'),
                    InlineKeyboardButton('Feedback', url='https://t.me/useIes')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/SiderzBot/11'),
                    InlineKeyboardButton('Source', url='https://github.com/DarkCybers/InnexiaRenameBot')
                ]
            ]
        ),
